...
def pr1():
    ...
    if a1.get()== '1' or a1.get()=='01':
        ...
        a= Label(nx, text='DECIMAL CONVERSION', font=("vani 30 bold"), fg="gold", bg="gray15", relief= GROOVE, padx=40, pady=7)
        a.place(x=500, y=20)
...
#   todo bin to all
    if a1.get()=='2' or a1.get()=='02':
        ...
        t = Label(nx, text="BINARY CONVERSION", font="vani 30 bold", fg="gold", bg="gray15",relief= SUNKEN, padx= 40, pady=7)
        t.place(x=500, y=20)
...
#    todo octal to all
    if a1.get() == '3' or a1.get()=='03':
        ...
        t =Label(nx, text="OCTAL CONVERSION", font="Vani 30 bold", relief= SUNKEN, padx= 40, pady=7, fg="gold", bg="gray15")
        t.place(x=500, y=20)
...
#     todo hexta to all
    if a1.get() == '4' or a1.get()=='04':
        ...
        t = Label(nx, text="HEXADECIMAL CONVERSION", font="Vani 30 bold", relief=SUNKEN, padx=40, pady=10, fg="gold", bg="gray15")
        t.place(x=420, y=20)
    ...
    if a1.get()== '5' or a1.get == '05':
        ...
        t=Label(x,text='BINARY OPERATIONS',font="Vani 30 bold", fg="gold", bg="gray15",relief=RIDGE)
        t.place(x=500, y=40)
    ...
    if a1.get() == '6' or a1.get()=='06':
        ...
        t = Label(k, text='DIVISION OPERATION', font="Vani 31 bold", fg="gold", bg="gray15", relief=RIDGE, padx=40, pady=7)
        t.place(x=500, y=10)
    ...
    if a1.get()=='7' or a1.get()=='07':
        ...
        n = Label(kk, text="1's & 2's COMPLEMENT", font="times 30 bold", fg="gold", bg="gray15", relief=SUNKEN, padx=30)
        n.place(x=510, y=20)
    ...
    if a1.get() == '8' or a1.get()=='08':
        ...
        t = Label(k, text='ENCRYPTION & DECRYPTION', font="Vani 31 bold", fg="gold", bg="gray15", relief=RIDGE, padx=40,
                  pady=7)
        t.place(x=420, y=10)
    ...
    if a1.get() == '9' or a1.get()=='09':
        ...
        t = Label(x, text="BIT'S CALCULATION", font="Vani 30 bold", fg="gold", bg="gray15", relief=RIDGE, padx=40,pady=7)
        t.place(x=520, y=10)
