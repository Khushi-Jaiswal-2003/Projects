...
def wish():
    ...
    if h>=0 and h<12:
        voice("Good Morning Khushi Jaiswal,i am your Assistant,how can i help you??")
    elif h>=12 and h<18:
        voice("Good after noon Khushi Jaiswal,i am your Assistant,how can i help you??")
    else:
        voice("Good evining Khushi Jaiswal,i am your Assistant,how can i help you??")
...
if "shut down" in fun:
    ...
    x1 = speek()
    if "yes" in x1:
        g="thank you,for your confirmation , now i am going to shut down your pc"
        voice(g)
    # todo shut down
...
# todo for restart
    ...
    x1 = speek()
    if "yes" in x1:
        g = "thank you,for your confirmation , now i am going to restart your pc"
        voice(g)
        # todo shut down
...
# todo file open
    ...
    g = "thank you,for your confirmation , now i am goining to open your File manager"
    voice(g)
...
# todo send whatsaap msg
    ...
    if a=="yes":
        ...
        if password == str(5550):
            g = "thank you,for your confirmation , now i am going to open your WhatsApp"
            voice(g)
...
# todo search in wikipedia
    ...
    g = "sorry,I'm not able to recognize your command"
    voice(g)
